This is a fork from the Duckietown docker-ros-vnc repository. Adjusted to create a shared folder between the host and container. 

Use the run.sh script to start the container.



Coming from the readme of the original repository:
